...
* 电驴ED2K中间的5044211712、磁力magnet最后的xl=5044211712为文件大小的字节数
* 使用比特彗星BitConmet添加磁力链接，然后选择稍后下载，右键下载文件-复制磁力-粘贴到文本中，最末尾的xl=5044211712则为字节数
...
```
##### game520夸克秒传123
* 123云盘秒传JSON生成器（夸克网盘/天翼云盘）（从夸克文件生成信息秒传进去123）
* https://gf.qytechs.cn/zh-CN/scripts/555404-123云盘秒传json生成器-夸克网盘-天翼云盘
